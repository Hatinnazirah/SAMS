...
import '../ManageCurriculumCoCurriculumActivities/StudentCurriculumPage.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ UPDATED: CURRICULUM button now redirects to StudentCurriculumPage
              _buildDashboardButton(
                label: 'CURRICULUM',
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) =>  StudentCurriculumPage(),
                    ),
                  );
                },
              ),
